...
import { getDepartments, getMunicipalities } from '../../actions/address';

export const Address = ({ handleCountry, country, handleDepartment, department, handleMunicipality, municipality, listMunicipalities }) => {
    ...
    const handleDepartmentChange = async (value) => {
        ...
        const municipalities = await getMunicipalities(selectedDepartment);
    ...
    return (
        <React.Fragment>
            <div style={{ borderStyle: 'solid', marginTop: '10px', width: '100%', padding: '0px 10px 10px 10px' }}>
                <h3>Dirección</h3>
                <Autocomplete
                    value={country?.label}
                    ...
                    inputValue={inputValueCountry?.label}
                        ...
                        {department !== '' ? (
                            <div>
                                <Autocomplete
                                    value={municipality}
                                    onChange={(event, newValue) => {
                                        handleMunicipality(newValue);
                                    }}
                                    inputValue={inputValueMunicipality}
                                    onInputChange={(event, newInputValue) => {
                                        setInputValueMunicipality(newInputValue);
                                    }}
                                    autoHighlight
